<%@ page import="rollerblade.Sponsorship" %>
...
<div class="fieldcontain ${hasErrors(bean: sponsorshipInstance, field: 'event', 'error')} required">
	...
	<g:select id="event" name="event.id" from="${rollerblade.TekEvent.list()}" optionKey="id" required="" value="${sponsorshipInstance?.event?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: sponsorshipInstance, field: 'sponsor', 'error')} required">
	...
	<g:select id="sponsor" name="sponsor.id" from="${rollerblade.Sponsor.list()}" optionKey="id" required="" value="${sponsorshipInstance?.sponsor?.id}" class="many-to-one"/>
